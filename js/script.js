...
const config = {
    serverInfo: {
        ...
        serverName: "Æonforge Empire", /*Server name*/
        serverIp: "mc.aeonforge-network.net", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1301568066961936464" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    */
    ...
    atGroupsDefaultColors: {
        gründer: "rgba(83, 131, 98, 0.5)",
        admins: "rgba(230, 83, 0, 0.5)",
        helfer: "rgba(11, 175, 255, 0.5)",
        baumeister: "rgba(247, 2, 176, 0.5)",
    },
    adminTeamPage: {
        gründer: [
            {
                inGameName: "NordicRacoon",
                rank: "Gründer",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(255, 3, 3, 1)"
            },
            {
                inGameName: "Black_Grizzly",
                rank: "Gründer",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(255, 3, 3, 1)"
            },
        ...
        baumeister: [
            {
                inGameName: "ZeusRonnok",
                rank: "Baumeister",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "DoctorHase",
                rank: "Baumeister",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
